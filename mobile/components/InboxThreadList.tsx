...
const styles = StyleSheet.create({
  ...
  title: { fontWeight: "600", color: theme.text, fontSize: 15, flex: 1, marginRight: 8 },
  titleUnread: { fontWeight: "700" },
  time: { fontSize: 12, color: theme.mutedLight, flexShrink: 0 },
  bottomRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 3 },
  preview: { fontSize: 14, color: theme.muted, flex: 1, marginRight: 8 },
